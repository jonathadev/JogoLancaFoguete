...
public partial class MicroSplatShaderGUI : ShaderGUI
{
   ...
   public class MicroSplatCompiler
   {
      ...
      public static bool HasDebugFeature (string[] features)
      {
         ...
         || features.Contains ("_DEBUG_OUTPUT_SPLAT0")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT1")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT2")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT3")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT4")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT5")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT6")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT7")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT0A")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT1A")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT2A")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT3A")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT4A")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT5A")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT6A")
         || features.Contains ("_DEBUG_OUTPUT_SPLAT7A")
#endif
            ;
      }
