...
{
   public static readonly string MicroSplatVersion = "2.9";
   ...
   void InitModules()
   {
      if (modules.Count == 0)
      {
         ...
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-global-texturing-96482?pubref=25047", "microsplat_module_globaltexture"));
#endif
#if !__MICROSPLAT_SNOW__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-dynamic-snow-96486?pubref=25047", "microsplat_module_snow"));
#endif
#if !__MICROSPLAT_TESSELLATION__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-tessellation-and-parallax-96484?pubref=25047", "microsplat_module_tessellation"));
#endif
#if !__MICROSPLAT_DETAILRESAMPLE__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-anti-tiling-module-96480?pubref=25047", "microsplat_module_detailresample"));
#endif
#if !__MICROSPLAT_TERRAINBLEND__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-terrain-blending-97364?pubref=25047", "microsplat_module_terrainblending"));
#endif
#if !__MICROSPLAT_STREAMS__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-puddles-streams-lava-wetness-97993?pubref=25047", "microsplat_module_streams"));
#endif
#if !__MICROSPLAT_ALPHAHOLE__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-terrain-holes-97495?pubref=25047", "microsplat_module_alphahole"));
#endif
#if !__MICROSPLAT_TRIPLANAR__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-triplanar-uvs-96777?pubref=25047", "microsplat_module_triplanaruvs"));
#endif
#if !__MICROSPLAT_TEXTURECLUSTERS__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-texture-clusters-104223?pubref=25047", "microsplat_module_textureclusters"));
#endif
#if !__MICROSPLAT_WINDGLITTER__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-wind-and-glitter-105627?pubref=25047", "microsplat_module_windglitter"));
#endif
#if !__MICROSPLAT_PROCTEX__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-runtime-procedural-texturing-143039?pubref=25047", "microsplat_module_proctexture"));
#endif
#if !__MICROSPLAT_LOWPOLY__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-low-poly-look-146119?aid=1011l37NJ&pubref=25047", "microsplat_module_lowpoly"));
#endif
#if !__MICROSPLAT_MESHTERRAIN__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-mesh-terrains-157356?aid=1011l37NJ&pubref=25047", "microsplat_module_terrainmesh"));
#endif

         if (modules.Count > 1)
         {
            modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-lwrp-urp-support-117808?aid=1011l37NJ&pubref=25047", "microsplat_module_urp"));
            modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-hdrp-support-157242?pubref=25047", "microsplat_module_hdrp"));
         }
