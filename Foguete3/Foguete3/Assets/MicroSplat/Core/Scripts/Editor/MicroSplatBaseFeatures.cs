...
namespace JBooth.MicroSplat
{
   ...
   public class MicroSplatBaseFeatures : FeatureDescriptor
   {
      ...
      #if __MICROSPLAT_MESHTERRAIN__ || __MICROSPLAT_MESH__
      public Workflow workflow = Workflow.UnityTerrain;
      #endif
      ...
      #if __MICROSPLAT_MESHTERRAIN__ || __MICROSPLAT_MESH__
      GUIContent CWorkflow = new GUIContent ("Workflow", "What type of object is this shader going to be used on");
      #endif
      ...
      public override string[] Pack()
      {
         ...
         #if __MICROSPLAT_MESHTERRAIN__
         if (workflow == Workflow.MeshTerrain)
         {
      ...
      public override void DrawPerTextureGUI(int index, MicroSplatKeywords keywords, Material mat, MicroSplatPropData propData)
      {
         ...
         if (samplerMode == SamplerMode.Default && (keywords.IsKeywordEnabled ("_PERTEXDISTANCERESAMPLEUVSCALE") || perTexUVScale))
         {
